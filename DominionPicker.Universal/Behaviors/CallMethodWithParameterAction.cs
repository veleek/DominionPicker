...
namespace Ben.Dominion.Behaviors
{
    ...
    /// </summary>
    public sealed class CallMethodWithParameterAction : DependencyObject, IAction
    {
        /// <summary>
        ...
        public static readonly DependencyProperty MethodNameProperty = DependencyProperty.Register(
            "MethodName",
            typeof(string),
            typeof(CallMethodWithParameterAction),
            new PropertyMetadata(null, new PropertyChangedCallback(CallMethodWithParameterAction.OnMethodNameChanged)));
        ...
        public static readonly DependencyProperty TargetObjectProperty = DependencyProperty.Register(
            ...
            typeof(object),
            typeof(CallMethodWithParameterAction),
            new PropertyMetadata(null, new PropertyChangedCallback(CallMethodWithParameterAction.OnTargetObjectChanged)));
        ...
        public string MethodName
        {
            get
            {
                return (string)this.GetValue(CallMethodWithParameterAction.MethodNameProperty);
            }

            set
            {
                this.SetValue(CallMethodWithParameterAction.MethodNameProperty, value);
            }
        }
        ...
        public object TargetObject
        {
            get
            {
                return this.GetValue(CallMethodWithParameterAction.TargetObjectProperty);
            }

            set
            {
                this.SetValue(CallMethodWithParameterAction.TargetObjectProperty, value);
            }
        }
        ...
        {
            object target;
            if (this.ReadLocalValue(CallMethodWithParameterAction.TargetObjectProperty) != DependencyProperty.UnsetValue)
            {
            ...
            {
                methodDescriptor.MethodInfo.Invoke(target, new object[] { this.Parameter });
                return true;
            }
