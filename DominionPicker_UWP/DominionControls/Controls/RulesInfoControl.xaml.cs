...
namespace Ben.Dominion.Controls
{
   ...
   public partial class RulesInfoControl
      : Windows.UI.Xaml.Controls.UserControl
   {
      ...
      public RulesInfoViewModel RulesInfo
      {
         get
         {
            return (RulesInfoViewModel)this.GetValue(RulesInfoProperty);
         }
         set
         {
            this.SetValue(RulesInfoProperty, value);
         }
      }

      // Using a DependencyProperty as the backing store for RulesInfo.  This enables animation, styling, binding, etc...
      public static readonly DependencyProperty RulesInfoProperty = DependencyProperty.Register("RulesInfo", typeof(RulesInfoViewModel), typeof(RulesInfoControl), new PropertyMetadata(null));

      private void LayoutRoot_OnTap(object sender, Windows.UI.Xaml.Input.TappedRoutedEventArgs e)
      {
      }

   }

   public class RulesInfoViewModel
      : NotifyPropertyChangedBase
   {
      ...
      public RulesInfoViewModel(CardSet set, string rulesUri)
      : this()
      {
         if ( set == CardSet.None )
         {
      ...
      public bool NeedDownload
      {
         ...
         private set
         {
            this.SetProperty(ref this.needDownload, value);
         }
      }
      ...
      public async Task DownloadRulesFileAsync()
      {
         ...
         Uri downloadUri = new Uri("ms-appx://" + this.localFileName);
      ...
      public async Task<IStorageFile> DownloadRulesFileAsync2()
      {
         ...
         //AppLog.Instance.Debug("Unable to find local rules PDF for {0}. Downloading from {1}", this.localFileName, this.RulesUri);
