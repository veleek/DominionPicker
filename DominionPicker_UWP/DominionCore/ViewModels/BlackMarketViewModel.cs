      ...
      : NotifyPropertyChangedBase
   {
      ...
      public static ReadOnlyCollection<Card> BaseBlackMarketCards
      {
         get
         {
            ...
            {
               baseBlackMarketCards = new ReadOnlyCollection<Card>(Cards.PickableCards.Except(new[] { Card.FromName("Black Market") }).ToList());
            }
      ...
      public CardList Deck
      {
         ...
         set
         {
            this.SetProperty(ref this.deck, value, "Deck");
         }
      }
      ...
      public CardList Hand
      {
         ...
         set
         {
            this.SetProperty(ref this.hand, value, "Hand");
         }
      }
      ...
      public Card Selected
      {
         ...
         set
         {
            this.SetProperty(ref this.selected, value, "Selected");
         }
      }
