...
namespace Ben.Dominion
{
    ...
    public class Picker
    {
        ...
        public PickerResult GenerateCardListNew(SettingsViewModel settings)
        {
            ...
            result.Pool = Cards.AllCards.Where(c => c.InSet(availableSets)) // Then filter to those in the available sets
        ...
        public void AddAdditionalCards(SettingsViewModel settings, PickerResult result)
        {
            ...
            if (result.HasCard("Young Witch"))
            {
                ...
                if (bane != null)
                {
                    bane.Move(result.Pool, result.AdditionalCards);
                }
            }
            ...
            if(settings.ShowExtras)
            {
                ...
                if (result.Cards.Any(c => c.Rules.Contains("{VP}")))
                {
